...
function EventCard({ eventId, eventName, description, communityName, startTime, endTime, location, capacity, availableSeats, ticketPrice, creatorAddress, bountyTitle, bountyDescription, bountyAmount }: EventCardProps): ReactNode {
  return (
...
function EventDetailsDialog({ eventName, communityName, description, startTime, endTime, location, creatorAddress, ticketPrice, capacity, availableSeats }: EventDetailsDialogProps): ReactNode {
  return (
    <Dialog>
        ...
        <div className="max-h-[60vh] overflow-y-auto">
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <p id="description" className="col-span-3">{description}</p>
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="time" className="text-right">Time</Label>
              <p id="time" className="col-span-3">Start: {startTime}<br />End: {endTime}</p>
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="location" className="text-right">Location</Label>
              <p id="location" className="col-span-3">{location}</p>
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <p id="ticket" className="col-span-3">{formatEther(ticketPrice)} ETH ({ticketPrice.toString()} WEI)</p>
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="capacity" className="text-right">Capacity</Label>
              <p id="capacity" className="col-span-3">{capacity} attendees</p>
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="available" className="text-right">Available Seats</Label>
              <p id="available" className="col-span-3">{availableSeats}</p>
            </div>
          </div>
        </div>
        <DialogFooter>
...
function BountyDetailsDialog({ eventId, eventName, bountyTitle, bountyDescription, bountyAmount }: BountyDetailsDialogProps): ReactNode {
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px] p-4">
        ...
        <div className="max-h-[60vh] overflow-y-auto p-4">
          <div className="grid gap-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <p id="bountyTitle" className="col-span-3">{bountyTitle}</p>
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="bountyDescription" className="text-right">Description</Label>
              <p id="bountyDescription" className="col-span-3">{bountyDescription}</p>
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="totalAmount" className="text-right">Total Amount</Label>
              <p id="totalAmount" className="col-span-3">{formatEther(bountyAmount)} ETH ({bountyAmount.toString()} WEI)</p>
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
        ...
        <DialogFooter className="p-4">
          <Button type="submit" onClick={handleContribute}>Fund Bounty</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
